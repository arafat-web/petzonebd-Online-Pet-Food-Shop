        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '›';" aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page" style="color: var(--ink);"> Search Results </li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            <div class="text-center">
                ...
                <p style="color: #777; margin-top: 0.5rem; font-size: 0.9rem;">
                    @if($search_query)
                        Found {{ $allfoods->count() }} results for "<strong>{{ $search_query }}</strong>"
                    @else
        ...
        <div class="container">
            @if($allfoods->isEmpty())
                <div class="text-center py-5">
                    ...
                    <p style="color: #777;">
                        @if($search_query)
                            We couldn't find any products matching "<strong>{{ $search_query }}</strong>". Try searching for something else!
                        @else
                            Enter a search term to find products
                        @endif
                    </p>
